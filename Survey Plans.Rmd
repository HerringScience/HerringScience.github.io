...
surv = "SB"
surv2 = "Scots Bay"
surv.date = "2024-06-16 20:00:00" #survey date and time, as formatted
surv.no = "4"
...
NVessel = "Leroy and Barry" #Set NA for GB or excluding box
...
#Add vessel names to Plan
Plan = Main %>% 
  mutate(Vessel = replace(Vessel, Vessel == "LJ", V1)) %>%
  mutate(Vessel = replace(Vessel, Vessel == "C1", V2)) %>%
  mutate(Vessel = replace(Vessel, Vessel == "FM", V3)) %>%
  mutate(Vessel = replace(Vessel, Vessel == "LM", V4)) %>%
  mutate(Vessel = replace(Vessel, Vessel == "V5", V5)) %>%
  mutate(Vessel = replace(Vessel, Vessel == "V6", V6)) %>%
  mutate(Vessel = replace(Vessel, Vessel == "V7", V7)) %>%
  mutate(Vessel = replace(Vessel, Vessel == "V8", V8)) %>%
  mutate(Vessel = replace(Vessel, Vessel == "V9", V9)) %>%
  mutate(Vessel = replace(Vessel, Vessel == "LB", NVessel)) %>%
  mutate(Vessel = replace(Vessel, Vessel == "BP", EVessel))
