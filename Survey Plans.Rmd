...
surv = "SB"
surv2 = "Scots Bay"
surv.date = "2024-08-25 20:00:00" #survey date and time, as formatted
surv.no = "9"
Allocation = "250" #set to "0" for a non-fishing survey
SIAllocation = NA #Seal Island allocation for GB-only
Tagging = "Lady Janice" #list vessel names in a single quote string (e.g. "Lady Melissa and Sealife II")
