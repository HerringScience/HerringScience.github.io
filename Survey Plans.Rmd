...
surv = "GB"
surv2 = "German Bank"
surv.date = "2023-09-13 20:30:00" #survey date and time, as formatted
surv.no = "4"
Allocation = "200" #set to "0" for a non-fishing survey
SIAllocation = "100" #Seal Island allocation for GB-only
Tagging = "Canada 100, Lady Janice II, Lady Melissa, Morning Star,Tasha Marie and Sealife II" #list vessel names in a single quote string (e.g. "Lady Melissa and Sealife II")
