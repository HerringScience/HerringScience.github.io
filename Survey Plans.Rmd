...
surv = "SB"
surv2 = "Scots Bay"
surv.date = "2024-05-24 19:00:00" #survey date and time, as formatted
surv.no = "1"
Allocation = "100" #set to "0" for a non-fishing survey
SIAllocation = "0" #Seal Island allocation for GB-only
Tagging = "Lady Janice, Sealife II, Lady Melissa" #list vessel names in a single quote string (e.g. "Lady Melissa and Sealife II")
