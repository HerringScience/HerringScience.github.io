...
surv = "SB"
surv2 = "Scots Bay"
surv.date = "2023-09-24 20:00:00" #survey date and time, as formatted
surv.no = "10"
Allocation = "200" #set to "0" for a non-fishing survey
SIAllocation = "0" #Seal Island allocation for GB-only
Tagging = "Canada 100, Fundy Monarch, Lady Melissa, Morning Star" #list vessel names in a single quote string (e.g. "Lady Melissa and Sealife II")
