...
surv = "SB"
surv2 = "Scots Bay"
surv.date = "2023-07-16 21:30"
surv.no = "5"
Allocation = "100" #set to "0" for a non-fishing survey
SIAllocation = "75"
vessels = 6
EVessel = "Canada 100"
NVessel = "Lady Melissa"
PlanktonVessel = "Lady Janice"
Tagging = "Sealife II, Lady Janice, Fundy Monarch, and Lady Melissa" #list vessel names in a single quote string (e.g. "Lady Melissa and Sealife II")
...
```{r}
Table %>%
  mutate(Vessel = ifelse(Vessel == "BP", "Brunswick Provider",
                  ifelse(Vessel == "C1", "Canada 100",
                  ifelse(Vessel == "SL", "Sealife II",
                  ifelse(Vessel == "LM", "Lady Melissa",
                  ifelse(Vessel == "LJ", "Lady Janice",
                  ifelse(Vessel == "TM", "Tasha Marie",
                  ifelse(Vessel == "FM", "Fundy Monarch",
                  ifelse(Vessel == "LB", "Leroy and Barry",
                  ifelse(Vessel == "MS", "Morning Star",
                  "NA")))))))))) %>%
  arrange(Vessel) %>%
  kbl() %>%
  kable_styling(full_width=FALSE) 
