...
surv = "SB"
surv2 = "Scots Bay"
surv.date = "2023-08-13 20:30:00"
surv.no = "7"
Allocation = "150" #set to "0" for a non-fishing survey
SIAllocation = "0" #Seal Island allocation for GB-only
Tagging = "Canada 100, Morning Star, Sealife II, and Lady Melissa" #list vessel names in a single quote string (e.g. "Lady Melissa and Sealife II")
