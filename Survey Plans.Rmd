...
surv = "GB"
surv2 = "German Bank"
surv.date = "2024-08-04 20:00:00" #survey date and time, as formatted
surv.no = "1"
...
#Add vessel names to Plan
Plan = Main %>%
  mutate(Vessel = replace(Vessel, Vessel == "LM", V1)) %>%
  mutate(Vessel = replace(Vessel, Vessel == "FM", V2)) %>%
  mutate(Vessel = replace(Vessel, Vessel == "C1", V3)) %>%
  mutate(Vessel = replace(Vessel, Vessel == "MS", V4)) %>%
  mutate(Vessel = replace(Vessel, Vessel == "LB", V5)) %>%
  mutate(Vessel = replace(Vessel, Vessel == "LJ", V6)) %>%
  mutate(Vessel = replace(Vessel, Vessel == "V6", V7)) %>%
  mutate(Vessel = replace(Vessel, Vessel == "V7", V8)) %>%
  mutate(Vessel = replace(Vessel, Vessel == "V8", V9)) %>%
