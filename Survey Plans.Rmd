...
surv = "GB"
surv2 = "German Bank"
surv.date = "2023-08-06 20:30:00"
surv.no = "1"
Allocation = "100" #set to "0" for a non-fishing survey
SIAllocation = "50" #Seal Island allocation for GB-only
Tagging = "Morning Star, Lady Janice II, Sealife II, and Lady Melissa" #list vessel names in a single quote string (e.g. "Lady Melissa and Sealife II")
...
```{r, include = "FALSE"}
#save all changes and information to planktonsamplingData.csv for Update Data and results
SurveyData = read_csv((paste0("C:/Users/", Sys.info()[7], "/Documents/GitHub/HerringScience.github.io/Source Data/planktonsamplingData.csv")))
SurveyData$StartTime = as.character(SurveyData$StartTime)
SurveyData$Net = as.character(SurveyData$Net)
...
Survey = full_join(SurveyData, CurrentData)
row = nrow(Survey)
Survey2 = Survey[rep(row, 1),]
Survey = rbind(Survey, Survey2)
Survey = Survey %>%
 dplyr::select(id, Sample, No_jars, Lon1, Lat1, Lon2, Lat2, AirTemp, Speed, Heading, TideDirection, CTD_ID, WindDirection, WindSpeed, Swell, FlowReading1, FlowReading2, Observers, DepthDiscD, DepthDiscA, Ground, Survey.No, Date, StartTime, Fishing, Vessel.No, ExtraBox, EVessel, NVessel, PlanktonVessel, Time1, Time2, TowTime, Gear, Net, TowType, AvgTowDepth, MaxTowDepth, AvgTemp, AvgSalinity, SurfaceTemp, WaterDepth1, WaterDepth2, FlowmeterType) 
