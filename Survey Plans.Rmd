...
surv = "GB"
surv2 = "German Bank"
surv.date = "2023-08-20 20:30:00"
surv.no = "2"
Allocation = "100" #set to "0" for a non-fishing survey
SIAllocation = "50" #Seal Island allocation for GB-only
Tagging = "Canada 100, Tasha Marie, Morning Star, Lady Janice II, Lady Melissa, Sealife II" #list vessel names in a single quote string (e.g. "Lady Melissa and Sealife II")
