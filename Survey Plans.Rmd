...
surv = "GB"
surv2 = "German Bank"
surv.date = "2023-09-03 20:30:00" #survey date and time, as formatted
surv.no = "3"
Allocation = "150" #set to "0" for a non-fishing survey
SIAllocation = "75" #Seal Island allocation for GB-only
Tagging = "Canada 100, Lady Janice II, Lady Melissa, Morning Star, Sealife II, Tasha Marie" #list vessel names in a single quote string (e.g. "Lady Melissa and Sealife II")
