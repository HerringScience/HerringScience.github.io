...
surv = "GB"
surv2 = "German Bank"
surv.date = "2023-10-11 20:00:00" #survey date and time, as formatted
surv.no = "6"
Allocation = "200" #set to "0" for a non-fishing survey
SIAllocation = "50" #Seal Island allocation for GB-only
Tagging = "Canada 100, Morning Star, Lady Janice, Sealife II" #list vessel names in a single quote string (e.g. "Lady Melissa and Sealife II")
