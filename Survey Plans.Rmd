...
a=if(surv == "SB" & !is.na(EVessel) & !is.na(NVessel)){
  ...
  paste(EVessel, "will each run 2 lines in the Main Box and 2 lines in the East Box, and", NVessel, "will run 1 line in the Main Box and 4 lines in the North box. Brunswick Provider will run 3 lines in the main box.")
  }
