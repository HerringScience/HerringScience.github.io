...
surv = "SB"
surv2 = "Scots Bay"
surv.date = "2024-08-11 20:00:00" #survey date and time, as formatted
surv.no = "8"
...
#Add vessel names to Plan
Plan = Main %>%
  mutate(Vessel = replace(Vessel, Vessel == "MS", V1)) %>%
  mutate(Vessel = replace(Vessel, Vessel == "LM", V2)) %>%
  mutate(Vessel = replace(Vessel, Vessel == "BP", V3)) %>%
  mutate(Vessel = replace(Vessel, Vessel == "C1", V4)) %>%
  mutate(Vessel = replace(Vessel, Vessel == "V5", V5)) %>%
  mutate(Vessel = replace(Vessel, Vessel == "V6", V6)) %>%
  mutate(Vessel = replace(Vessel, Vessel == "V7", V7)) %>%
  mutate(Vessel = replace(Vessel, Vessel == "V8", V8)) %>%
