...
#Trying for loop to speed up process. Currently not working. 
...
#   r$Y[i] = test1$Lat
#   r$X[i] = test1$Lon
#     with (r, ifelse(r$Scots_Bay[i] == point.in.polygon(r$Y[i], r$X[i], area7$Y, area7$X, mode.checked=FALSE), 1,
