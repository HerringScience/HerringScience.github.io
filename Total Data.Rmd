...
completeReturns <- read_csv("C:/Users/herri/Documents/GitHub/HerringScience.github.io/Source Data/Tagging/Tag Returns/Full Returns.csv")
...
tag_points_df <- TaggingEvents %>%
  ...
  distinct(TAG_NUMBER, .keep_all = TRUE)
...
r_final <- joined_spatial %>%
  st_drop_geometry() %>%
  dplyr::select(TAG_NUMBER, Ground) %>%
  mutate(Ground = case_when(
    is.na(FishingGround)       ~ "Other",
    FishingGround == "Browns Bank" ~ "Brown Bank",
    TRUE                       ~ FishingGround
  ))
