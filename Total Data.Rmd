...
#These are all just Category 1s, which are 0-2 days to recapture
...
SummaryTable <- subset(TagReturnsGB, select = c(category, FishingGround, catchAREA, AvgtimeDifference, timeDifferenceMin, timeDifferenceMax))
SummaryTable <- SummaryTable %>%
  group_by(FishingGround, catchAREA, category) %>%
  mutate(amountInCategory = length(category))
 SummaryTable <- unique(SummaryTable) %>%
...
SummaryTable <- subset(TagReturnsNBC, select = c(category, FishingGround, catchAREA, AvgtimeDifference, timeDifferenceMin, timeDifferenceMax))
SummaryTable <- SummaryTable %>%
  group_by(FishingGround, catchAREA, category) %>%
  mutate(amountInCategory = length(category))
 SummaryTable <- unique(SummaryTable) %>%
...
SummaryTable <- subset(TagReturnsGM, select = c(category, FishingGround, catchAREA, AvgtimeDifference, timeDifferenceMin, timeDifferenceMax))
SummaryTable <- SummaryTable %>%
  group_by(FishingGround, catchAREA, category) %>%
  mutate(amountInCategory = length(category))
 SummaryTable <- unique(SummaryTable) %>%
...
SummaryTable <- subset(TableGMB, select = -c(timeDifference, Date, DATE,  No.ofSameNumberOfDays, TAG_NUMBER, No.InCategory))
SummaryTable <- SummaryTable %>%
  group_by(category) %>%
  mutate(amountInCategory = length(category))
SummaryTable <- unique(SummaryTable) %>%
...
SummaryTable <- subset(TableLI, select = -c(timeDifference, Date, DATE,  No.ofSameNumberOfDays, TAG_NUMBER, No.InCategory))
SummaryTable <- SummaryTable %>%
  group_by(category) %>%
  mutate(amountInCategory = length(category))
SummaryTable <- unique(SummaryTable) %>%
...
SummaryTable <- subset(TableSI, select = -c(timeDifference, Date, DATE,  No.ofSameNumberOfDays, TAG_NUMBER, No.InCategory))
SummaryTable <- SummaryTable %>%
  group_by(category) %>%
  mutate(amountInCategory = length(category))
SummaryTable <- unique(SummaryTable) %>%
...
SummaryTable <- subset(TableSB, select = -c(timeDifference, Date, DATE,  No.ofSameNumberOfDays, TAG_NUMBER, No.InCategory))
SummaryTable <- SummaryTable %>%
  group_by(category) %>%
  mutate(amountInCategory = length(category))
SummaryTable <- unique(SummaryTable) %>%
