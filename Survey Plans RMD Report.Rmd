...
#Load plan
setwd(paste0("G:/.shortcut-targets-by-id/1TK7GaNVtjsT_n5XLgTIC8iu4KPN6mAb7/Herring Science Council/Sharepoint/R Markdown/HTML Markdown/Surveys/", year, "/", surv, surv.no, "/"))
...
#Land Data
setwd("G:/.shortcut-targets-by-id/1TK7GaNVtjsT_n5XLgTIC8iu4KPN6mAb7/Herring Science Council/Sharepoint/R Markdown/HTML Markdown/")
...
```{r}
if(surv=="SB"){
    knitr::include_graphics(paste0("Surveys/", year, "/", surv, surv.no, "/Daily.jpg"))
}
```