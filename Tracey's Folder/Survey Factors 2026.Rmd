...
GermanBankPeakBiomassPointGraph <- print(ggplot(GermanBankPeakBiomass, aes(x=Year, y=DFO_Estimate)) + 
  geom_point() +
  geom_line())
...
ggplot(CombinedPlot, aes(x=Year)) + 
          geom_line(aes(y=DFO_Turnover_Adjusted, color = "German Bank Total Yearly Biomass")) + 
          geom_line(aes(y=DFO_Estimate, color = "German Bank Peak Biomass")) +
