...
A = read_csv("C:/Users/darre/Documents/GitHub/HerringScience.github.io/Surveys/2026/SB4/tableA.csv")
A = A %>% mutate(Type = "Actual")
plan = read_csv("C:/Users/darre/Documents/GitHub/HerringScience.github.io/Surveys/2026/SB4/survey plan.csv")
...
Distance %>% write_csv("Distance2.csv")
