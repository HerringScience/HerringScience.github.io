...
#SURV <-read.csv("C:/Users/DebertinA/Documents/4VWX Herring/Acoustic Index Review Files/Target strength Calculations/2022/TS_est_2022_SB.csv")
...
ggsave(paste0("E:/Acoustic Index Review Files/Figures/",
              year(as.Date(surveydate)),
              "/SB/",
              "Area_ScotsBay_Main",
              surveydate,
              ".png"
...
overlapPlot <- ggsave(paste0("E:/Acoustic Index Review Files/Figures/",
              year(as.Date(surveydate)),
              "/SB/",
              "Area_ScotsBay_overlap",
              surveydate,
              ".png"
