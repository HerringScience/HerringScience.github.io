...
# August 8, 2020
# 9 boats in the main box
# There were samples
# TS applied from August 4, 2020: -35.1230 for 38 and -35.2303 for 50
...
# Map
mapping = read.table("Map_aug82020.csv", header=TRUE, sep=",", row.names = "id", stringsAsFactors=FALSE)

mapping = read.table("Map_Aug09_2020.csv", header=TRUE, sep=",", row.names = "id", stringsAsFactors=FALSE)
...
trans = transects(x= regions, TS38 = -35.1230 , TS50 = -35.2303 )
