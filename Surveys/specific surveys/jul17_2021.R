...
regions = read.table("Region_Jul17_2021.csv", header=TRUE, sep=",", row.names = "id", stringsAsFactors=FALSE)
...
trans = transects(x= regions, TS38 = -34.74272823 , TS50 = -35.609 )
...
trans_survey= trans[which(trans$Survey_date == "Jul17_2021"), ]
...
# Northern
northern=trans_survey[which(trans_survey$Vessel == "LB"), ]
