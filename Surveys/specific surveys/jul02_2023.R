...
regions = read.table("Region_Jul02_2023.csv", header=TRUE, sep=",", row.names = "id", stringsAsFactors=FALSE)

mapping = read.table("Map_Jul02_2023.csv", header=TRUE, sep=",", row.names = "id", stringsAsFactors=FALSE)
...
ids1 = c("LB_T01", "LB_T02","LB_T03", "LB_T04")
northern = trans[which((trans$RegionName %in% ids1)), ]

ids2 = c("SL_T01","SL_T02", "SL_T03", "SL_T04")
eastern = trans[which((trans$RegionName %in% ids2)), ]

ids3 =c("BP_T01","BP_T02", "C1_T01", "C1_T02", "LJ_T01", "LJ_T02", "TM_T01","TM_T02")
