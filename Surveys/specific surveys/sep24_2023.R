...
regions = read.table("Region_Sep24_2023.csv", header=TRUE, sep=",", row.names = "id", stringsAsFactors=FALSE)

mapping = read.table("Map_Sep24_2023.csv", header=TRUE, sep=",", row.names = "id", stringsAsFactors=FALSE)
