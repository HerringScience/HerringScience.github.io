...
# Sep 20, 2018 German Bank
regions = read.table("Region_Sep20_2018.csv", header=TRUE, sep=",", row.names = "id", stringsAsFactors=FALSE)
mapping = read.table("Map_Sep20_2018.csv", header=TRUE, sep=",", row.names = "id", stringsAsFactors=FALSE)
...
trans_survey= trans[which(trans$Survey_date == "Sep20_2018"), ]

# QC
unique(trans_survey$Survey_date)
unique(trans_survey$Vessel)

resultsa = biomassCalc(x = trans_survey, areaKm =828.09)
...
x2 = c(-66.3566, -66.3601, -66.3432)
y2 = c(43.37263, 43.46845, 43.464)
