...
home.path = 'C:/Users/herri/OneDrive/Documents/Surveys/2022/2022-06-12/'
data.path = 'C:/Users/herri/OneDrive/Documents/Surveys/2022/2022-06-12/'
...
calFiles <- grep("cal_202", calFiles, value =TRUE, fixed =TRUE) #really odd R bug, had to code it this way. Had to use last year's calibration file for LJ until we have this years
