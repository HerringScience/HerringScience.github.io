...
# August 23, 2021 German Banks
regions = read.table("Region_Aug23_2021.csv", header=TRUE, sep=",", row.names = "id", stringsAsFactors=FALSE)

mapping = read.table("Map_Aug23_2021.csv", header=TRUE, sep=",", row.names = "id", stringsAsFactors=FALSE)
...
trans_survey= trans[which(trans$Survey_date == "Aug23_2021"), ]
...
resultsb = biomassCalc(x = trans_surveySI, areaKm = 253.16)
