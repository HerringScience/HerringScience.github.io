...
# Map
mapping = read.table("MapSep13_2020.csv", header=TRUE, sep=",", row.names = "id", stringsAsFactors=FALSE)

map = mapDat(x = mapping)

# Results from German Bank/Seal Island Sep 9, 2019
# Target Strength (38kHz) =	-34.9734
# Target Strength (50kHz) =	-35.0807


trans = transects(x= regions, TS38 =-34.9734 , TS50 = -35.0807 )
head(boxes)
...
name = "September 13, 2020 - German Bank and Seal Island Survey Track"
