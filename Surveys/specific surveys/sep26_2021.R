...
regions = read.table("Region_Sep26_2021.csv", header=TRUE, sep=",", row.names = "id", stringsAsFactors=FALSE)

mapping = read.table("Map_Sep26_2021.csv", header=TRUE, sep=",", row.names = "id", stringsAsFactors=FALSE)
...
trans_survey= trans[which(trans$Survey_date == "Sep26_2021"), ]
...
# Results
resultsa = biomassCalc(x = trans_survey, areaKm = 352.7)
