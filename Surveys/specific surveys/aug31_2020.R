...
# Map
mapping = read.table("MapAug31_20.csv", header=TRUE, sep=",", row.names = "id", stringsAsFactors=FALSE)

map = mapDat(x = mapping)

# Results from German Bank/Seal Island August 25, 2019
trans = transects(x= regions, TS38 =-35.2155 , TS50 = -35.3228 )
head(boxes)
...
name = "August 31, 2020 - German Bank and Seal Island Survey Track"
