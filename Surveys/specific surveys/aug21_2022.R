...
#Aug 21 2022
regions = read.table("Region_Aug21_2022.csv", header=TRUE, sep=",", row.names = "id", stringsAsFactors=FALSE)
mapping = read.table("Map_Aug21_2022.csv", header=TRUE, sep=",", row.names = "id", stringsAsFactors=FALSE)
...
trans = transects(x= regions, TS38 = -35.43, TS50 = NA )
...
# TS and DFO Area Results
resultsa = biomassCalc(x = trans, areaKm = 607)
a = unique(resultsa$total_biomass)
a
