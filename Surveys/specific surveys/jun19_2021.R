...
# jun 19, 2021 Scots Bay
regions = read.table("Region_June19_21.csv", header=TRUE, sep=",", row.names = "id", stringsAsFactors=FALSE)

mapping = read.table("Map_June19_21.csv", header=TRUE, sep=",", row.names = "id", stringsAsFactors=FALSE)
...
trans = transects(x= regions, TS38 = -35.14369309, TS50 = NA )
...
trans_survey= trans[which(trans$Survey_date == "Jun19_2021"), ]
...
# Northern
northern=trans_survey[which(trans_survey$Vessel == "LJ"), ]
