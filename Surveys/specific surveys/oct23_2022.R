...
# Survey analysis
regions = read.table("Region_Oct23_2022.csv", header=TRUE, sep=",", row.names = "id", stringsAsFactors=FALSE)
mapping = read.table("Map_Oct23_2022.csv", header=TRUE, sep=",", row.names = "id", stringsAsFactors=FALSE)
...
trans_survey= trans[which(trans$Survey_date == "Oct23_2022"), ]
...
#22,457
# DFO uses 284
resultsb = biomassCalc(x = SI, areaKm = 284)
