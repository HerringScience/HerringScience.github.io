...
# Survey analysis
regions = read.table("Region_Sep27_2015.csv", header=TRUE, sep=",", row.names = "id", stringsAsFactors=FALSE)
...
trans_survey= trans[which(trans$Survey_date == "Sep27_2015"), ]
...
resultsa = biomassCalc(x = trans_survey, areaKm = 645)
