...
# Survey analysis
regions = read.table("Region_Aug17_Rab.Check.csv", header=TRUE, sep=",", row.names = "id", stringsAsFactors=FALSE)
...
trans_survey= trans[which(trans$Survey_date == "Aug17_2015"), ]
...
resultsa = biomassCalc(x = trans_survey, areaKm = 843)
