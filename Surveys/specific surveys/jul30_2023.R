...
regions = read.table("Region_Jul30_2023.csv", header=TRUE, sep=",", row.names = "id", stringsAsFactors=FALSE)

mapping = read.table("Map_Jul30_2023.csv", header=TRUE, sep=",", row.names = "id", stringsAsFactors=FALSE)
