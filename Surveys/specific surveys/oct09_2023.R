...
regions = read.table("Region_Oct09_2023.csv", header=TRUE, sep=",", row.names = "id", stringsAsFactors=FALSE)

mapping = read.table("Map_Oct09_2023.csv", header=TRUE, sep=",", row.names = "id", stringsAsFactors=FALSE)
