...
regions = read.table("Region_Aug13_2023.csv", header=TRUE, sep=",", row.names = "id", stringsAsFactors=FALSE)

mapping = read.table("Map_Aug13_2023.csv", header=TRUE, sep=",", row.names = "id", stringsAsFactors=FALSE)
