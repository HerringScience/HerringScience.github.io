...
surv = "GB"
surv2 = "German Bank"
surv.date = "2026-09-20 19:30:00" #survey date and time, as formatted.
surv.no = "4"
Allocation = '250' #set to "0" for a non-fishing survey
...
Plan2 = Plan %>% #convert the vessel names (on a separate Plan2) to their shorthand forms for other tools to use
  mutate(Vessel = replace(Vessel, Vessel == "Leroy and Barry" | Vessel == "Leroy & Barry", "LB")) %>%
...
d=if(surv=="GB"){
  paste(PlanktonVessel, "will run 2 lines in the German Bank Box, and 2 lines in the Seal Island Box. All other vessels will complete 3 lines in the German Bank Box and 1 line in the Seal Island Box")
}
...
e=paste0(Allocation, "mt/vessel for German Bank and Seal Island combined.")
