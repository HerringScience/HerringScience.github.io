...
year = "2026"
surv.no = "3"
hightide = "2026-07-06 18:00:00" #for Scots Bay only; YYYY-DD-MM (for some reason)
mainBoxVessels = 5
Tow = "N"
...
if(surv == "SB")
  {n = paste0(a, " commercial purse seiners conducted this ", b, " survey on ", c, " starting at ", d, ", which was ", k, " hour ", j, " hide tide.")}
if(surv == "GB")
...
Each vessel was equipped with a Simrad ES38-18/200-18C combi (2-in-1) transducer prior to the survey that contains a 38kHz split beam and 200 kHz single beam transducer. Data was logged to the computer hard-drive for post-processing.
