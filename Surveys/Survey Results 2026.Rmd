...
year = "2026"
surv.no = "3"
hightide = "2026-09-06 19:08:00" #for Scots Bay only; YYYY-MM-DD
mainBoxVessels = 7
Tow = "Y"
...
g=unique(ifelse(Survey$Ground == "GB", "The Lady Janice II ran two transects in the German Bank box and two transects in the Seal Island box. All other vessels ran three transects in the German Bank box and one transect in the Seal Island Box", 
         ...
         ifelse(Survey$Ground == "SB" & Survey$ExtraBox == "North", paste("All vessels ran two transects each in the Main Survey Box, and the ", f, "ran four lines in the Northern Survey Box"), 
          ifelse(Survey$Ground == "SB" & Survey$ExtraBox == "Both", paste( mainBoxVessels, "vessels ran various transects each in the Main Survey Box, the ", e, "ran various lines in the Eastern Survey Box, and the ", f, "ran various lines in the Northern Survey Box"),
         "NA"))))))
...
Annual_Compare5 = full_join(Annual_Compare1, Annual_Compare2, by=c("Ground", "Survey_Number", "Year", "Survey_Date", "HSC_Estimate", "HSC_Turnover_Adjusted")) %>%
 ...
 dplyr::summarize("HSC Estimate" = sum(HSC_Estimate),
...
::: row
::: col-md-6
```{r fig.align='center', fig.cap="Plankton tow depth profile #1"}
...
::: col-md-6
```{r fig.align='center', fig.cap="Plankton tow depth profile #2"}
...
```{r fig.align='center', fig.cap="Captured plankton from the surface tows"}
...
```{r fig.align='center', fig.show="first", results="hide"}
