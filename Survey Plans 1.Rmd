...
surv = "SB"
surv2 = "Scots Bay"
surv.date = "2025-05-18 20:00:00" #survey date and time, as formatted
surv.no = "2"
...
#Set vessels below
vessels = 4
EVessel = "Morning Star" #Set NA for GB or excluding box
NVessel = "Lady Melissa" #Set NA for GB or excluding box
PlanktonVessel = NA
...
a=if(surv == "SB" & !is.na(EVessel) & !is.na(NVessel)){
  ...
  paste(EVessel, " and Brunswick Provider will each run 2 lines in the Main Box and 2 lines in the East Box, and", NVessel, "will run 1 line in the Main Box and 4 lines in the North box. Fundy Monarch will run 4 lines in the main box.")
  }
