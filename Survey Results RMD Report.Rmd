...
```{r DATA CHECK RUN THIS FIRST MANUALLY, include=FALSE}
rm(list = ls())
...
#This will show you what photos or data are missing in the console below
#If none show up (character(0)), press Knit
current=paste0(surv, surv.no)
setwd(paste0("C:/Users/", Sys.info()[7],"/Documents/GitHub/HerringScience.github.io/HTML Markdown/Surveys/", year, "/", current))
files = list.files(pattern=c("Missing.csv", "Missing.jpg"))
print(files)
```
...
```{r, fig.align='center'}
knitr::include_graphics(path = paste0("C:/Users/", Sys.info()[7],"/Documents/GitHub/HerringScience.github.io/HTML Markdown/Surveys/", year, "/", current, "/Hourly.jpg"), rel_path = FALSE)
knitr::include_graphics(path = paste0("C:/Users/", Sys.info()[7],"/Documents/GitHub/HerringScience.github.io/HTML Markdown/Surveys/", year, "/", current, "/Daily.jpg"), rel_path = FALSE)
...
```{r Biomass details}
a=SSB %>% filter(Ground == surv2 & Year==year & Survey_Number == surv.no)
b=unique(a$HSC_Estimate)
b=format(b, big.mark=(","), digits=2)
c=unique(a$HSC_Turnover_Adjusted)
c=format(c, big.mark=(","), digits=2)
d=SSB %>% filter(Ground == "Seal Island" & Year == year & Survey_Number == surv.no)
e=unique(d$HSC_Estimate)
e=format(e, big.mark=(","), digits=2)
f=unique(ifelse(Survey$Ground=="GB", paste0("Preliminary biomass prediction for German Bank using standardized parallel transects is ", b, "mt, and with turnover ", c, "mt. The preliminary biomass estimate for Seal Island is ", e, "mt."), paste0("Preliminary biomass prediction for Scots Bay using standardized parallel transects is ", b, "mt, and with turnover ", c, "mt.")))
```
...
knitr::include_graphics(path = paste0("C:/Users/", Sys.info()[7],"/Documents/GitHub/HerringScience.github.io/HTML Markdown/Surveys/", year, "/", current, "/Snip.jpg"), rel_path = FALSE)
```
...
knitr::include_graphics(path = paste0("C:/Users/", Sys.info()[7],"/Documents/GitHub/HerringScience.github.io/HTML Markdown/Surveys/", year, "/", current, "/Tow 1.jpg"), rel_path = FALSE)
```
:::

::: col-md-6
```{r, fig.cap="Plankton tow depth profile #2", fig.align='center'}
knitr::include_graphics(path = paste0("C:/Users/", Sys.info()[7],"/Documents/GitHub/HerringScience.github.io/HTML Markdown/Surveys/", year, "/", current, "/Tow 2.jpg"), rel_path = FALSE)
```
:::
:::
...
knitr::include_graphics(path = paste0("C:/Users/", Sys.info()[7],"/Documents/GitHub/HerringScience.github.io/HTML Markdown/Surveys/", year, "/", current, "/Plankton.jpg"), rel_path = FALSE)
```
