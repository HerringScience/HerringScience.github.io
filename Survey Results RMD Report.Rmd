...
Paths = c("C:/Users/herri/Documents/GitHub/HerringScience.github.io/", "C:/Users/jenna/Documents/GitHub/HerringScience.github.io/")
names(Paths) = c("herri", "jenna")
current=paste0(surv, surv.no)
setwd(paste0(Paths[Sys.info()[7]], "HTML Markdown/Surveys/", year, "/", current))
...
## Global options
knitr::opts_knit$set(root.dir = paste0(Paths[Sys.info()[7]],"HTML Markdown/"))
...
#Packages
setwd(paste0(Paths[Sys.info()[7]], "Main Data"))
library(cli)
library(lubridate)
library(reprex)
library(tidyverse)
...
#Import All Boxes
setwd(paste0(Paths[Sys.info()[7]], "Box Coordinates/"))
