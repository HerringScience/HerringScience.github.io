...
setwd(paste0("G:/.shortcut-targets-by-id/1TK7GaNVtjsT_n5XLgTIC8iu4KPN6mAb7/Herring Science Council/Sharepoint/R Markdown/HTML Markdown/Surveys/", year, "/", current))
...
## Global options
knitr::opts_knit$set(root.dir = 'G:/.shortcut-targets-by-id/1TK7GaNVtjsT_n5XLgTIC8iu4KPN6mAb7/Herring Science Council/Sharepoint/R Markdown/HTML Markdown/')
...
#Packages
setwd("G:/.shortcut-targets-by-id/1TK7GaNVtjsT_n5XLgTIC8iu4KPN6mAb7/Herring Science Council/Sharepoint/R Markdown/Main Data/")
library(cli)
library(lubridate)
library(reprex)
library(tidyverse)
...
#Import All Boxes
setwd("G:/.shortcut-targets-by-id/1TK7GaNVtjsT_n5XLgTIC8iu4KPN6mAb7/Herring Science Council/Sharepoint/R Markdown/Box Coordinates/")
...
```{r, fig.align='center'}
knitr::include_graphics(paste0("Surveys/", year, "/", current, "/Hourly.jpg"))
knitr::include_graphics(paste0("Surveys/", year, "/", current, "/Daily.jpg"))
...
knitr::include_graphics(paste0("Surveys/", year, "/", current, "/Snip.jpg"))
```
...
knitr::include_graphics(paste0("Surveys/", year, "/", current, "/Tow 1.jpg"))
```
:::

::: col-md-6
```{r, fig.cap="Plankton tow depth profile #2", fig.align='center'}
knitr::include_graphics(paste0("Surveys/", year, "/", current, "/Tow 2.jpg"))
```
:::
:::
...
knitr::include_graphics(paste0("Surveys/", year, "/", current, "/Plankton.jpg"))
```
