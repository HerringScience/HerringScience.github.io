...
a=if(surv == "SB" & !is.na(EVessel) & !is.na(NVessel)){
  ...
  paste(EVessel, " and Brunswick Provider will each run 2 lines in the Main Box and 2 lines in the East Box, and", NVessel, "will run 1 line in the Main Box and 4 lines in the North box. Fundy Monarch will run 3 lines in the main box.")
  }
