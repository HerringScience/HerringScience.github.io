...
load( "C:/Users/herri/Documents/GitHub/HerringScience.github.io/Source Data/Larval Data/larvNew.RData")
...
```{r AdjustedLarval_SurveyJulian, results = "asis", fig.align='center'}
...
```{r HistogramLarvalLength, results = "asis", fig.align='center'}
...
```{r Maps, echo=FALSE, fig.align='center'}
...
```{r Depth1, results = "asis", fig.align='center'}
for(i in unique(Larval$Year)) {
...
```{r Depth2, echo=FALSE, fig.align='center'}
...
```{r Depth3, results = "asis", fig.align='center'}
for(i in unique(Larval$Year)) {
...
```{r PurplePlant, fig.align='center'}
...
```{r DensityAbundance, results='asis', fig.align='center'}
...
```{r IndivSpawnDates, results = 'asis', echo=FALSE, fig.align='center'}
...
```{r Year, results = 'asis', echo=FALSE, fig.align='center'}
...
```{r TowID, results = 'asis', echo=FALSE, fig.align='center'}
...
```{r GermanBank, echo=FALSE, fig.align='center'}
...
```{r GermanBank2, results = "asis", fig.align='center'}
...
```{r MappedD, message=FALSE, warning=FALSE}
...
```{r Total, echo=FALSE, fig.align='center'}
...
```{r YearGround, results = "asis", fig.align='center'}
for(i in unique(Larval$Year)) {
...
```{r GermanBank3, echo=FALSE, fig.align='center'}
...
```{r GermanBank4, results = "asis", fig.align='center'}
for(i in unique(Larval$Year)) {
...
```{r LarvalYear, results='asis', fig.align='center'}
...
```{r DateSpawned, results = 'asis', echo=FALSE, fig.align='center'}
...
```{r YearSpawned, results = 'asis', echo=FALSE, fig.align='center'}
...
```{r TowID__, results = 'asis', echo=FALSE, fig.align='center'}
...
```{r SealIsland, echo=FALSE, fig.align='center'}
...
```{r SealIsland2, results = "asis", fig.align='center'}
for(i in unique(Larval$Year)) {
...
```{r Mapping5, message=FALSE, warning=FALSE}
...
```{r SI, echo=FALSE, fig.align='center'}
...
```{r SI4, results = "asis", fig.align='center'}
for(i in unique(Larval$Year)) {
...
```{r TotalDepth, echo=FALSE, fig.align='center'}
...
```{r DepthAgain, results = "asis", fig.align='center'}
for(i in unique(Larval$Year)) {
...
```{r GrowthSpawnModes, fig.align='center'}
...
```{r LarvalSum, results='asis', fig.align='center'}
...
```{r IndvSpawn, results = 'asis', echo=FALSE, fig.align='center'}
...
```{r YearSpawn, results = 'asis', echo=FALSE, fig.align='center'}
...
```{r TwoTow, results = 'asis', echo=FALSE, fig.align='center'}
