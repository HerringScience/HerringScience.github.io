...
# SummaryTable <- subset(Table, select = -c(timeDifference, No.ofSameNumberOfDays))
...
SummaryTable <- subset(Table, select = -c(timeDifference, Date, DATE,  No.ofSameNumberOfDays))
SummaryTable <- unique(SummaryTable) %>%
  arrange(category)
