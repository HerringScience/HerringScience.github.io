...
g=unique(ifelse(Survey$Ground == "GB", "The Morning Star and the Lady Melissa were able to complete two transects each in the German Bank and Seal Island Box. The Brunswick Provider completed two transects in the German Bank box but were unable to complete the lines in Seal Island due to problems with the boat and weather.",
