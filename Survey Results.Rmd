...
year = "2025"
surv.no = "1"
hightide = "2025-07-28 15:30:00" #for Scots Bay only
mainBoxVessels = 5
Tow = "N"
...
kbl(Annual_Compare1, caption="Table 5: Annual Summary Table", format.args=list(big.mark=",")) %>%
  kable_paper("striped", full_width=F)
```
...
::: row
::: col-md-6
```{r eval=FALSE, fig.align='center', fig.show="first", include=FALSE, results="hide"}
...
```{r Tow table, eval=FALSE, include=FALSE}
...
::: row
::: col-md-6
```{r eval=FALSE, fig.align='center', fig.cap="Plankton tow depth profile #1", include=FALSE}
...
::: col-md-6
```{r eval=FALSE, fig.align='center', fig.cap="Plankton tow depth profile #2", include=FALSE}
...
```{r eval=FALSE, fig.align='center', fig.cap="Captured plankton from the surface tows", include=FALSE}
