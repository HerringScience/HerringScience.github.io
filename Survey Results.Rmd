...
year = "2025"
surv.no = "3"
hightide = "2025-06-03 19:03:00" #for Scots Bay only
...
g=unique(ifelse(Survey$Ground == "GB", "All vessels ran two transects in the German Bank box and two transect in the Seal Island Box", 
         ...
         ifelse(Survey$Ground == "SB" & Survey$ExtraBox == "North", paste("All vessels ran two transects each in the Main Survey Box, and the ", f, "ran four lines in the Northern Survey Box"), 
          ifelse(Survey$Ground == "SB" & Survey$ExtraBox == "Both", paste("The Canada 100 ran 3 lines in the Main Survey Box, the Brunswick Provider ran 2 lines in both the Main and Eastern Survey Box, and the Lady Melissa ran 1 line in the Main Survey Box and 4 line in the Northern Survey Box."),
