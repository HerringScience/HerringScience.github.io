...
SUA = read.csv(paste0("C:/Users/", Sys.info()[7],"/Documents/GitHub/HerringScience.github.io/Surveys/", year, "/", current, "/Box Coordinates/polygon_SBEastern.csv"))
polyEastern = as.PolySet(SUA, projection="LL")

SUA = read.csv(paste0("C:/Users/", Sys.info()[7],"/Documents/GitHub/HerringScience.github.io/Surveys/", year, "/", current, "/Box Coordinates/polygon_SBNorthern.csv"))
polyNorthern = as.PolySet(SUA, projection="LL")

SUA = read.csv(paste0("C:/Users/", Sys.info()[7],"/Documents/GitHub/HerringScience.github.io/Surveys/", year, "/", current, "/Box Coordinates/polygon_SB.csv"))
polySB_main = as.PolySet(SUA, projection="LL")
...
`r a` commercial purse seiners conducted this `r b` survey on `r c` starting at `r d`, which was `r k` hours `r j` high tide.
