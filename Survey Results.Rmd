...
year = "2025"
surv.no = "2"
hightide = "2025-05-20 18:15:00" #for Scots Bay only
...
g=unique(ifelse(Survey$Ground == "GB", "All vessels ran two transects in the German Bank box and two transect in the Seal Island Box", 
         ...
         ifelse(Survey$Ground == "SB" & Survey$ExtraBox == "North", paste("All vessels ran two transects each in the Main Survey Box, and the ", f, "ran four lines in the Northern Survey Box"), 
          ifelse(Survey$Ground == "SB" & Survey$ExtraBox == "Both", paste("The Brunswick Provider ran 2 in each the Main and the Eastern Survey Box, the Lady Melissa ran one line in the Main Survey Box and 4 lines in the Northern Survey Box, and the Canada 100 ran 3 lines in the Main Survey Box."),
                                                                          
                                                                          #"All vessels ran two transects each in the Main Survey Box, the ", e, "ran four lines in the Eastern Survey Box, and the ", f, "ran four lines in the Northern Survey Box"),
         "NA"))))))
