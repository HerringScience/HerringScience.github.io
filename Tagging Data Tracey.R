...
Tag_Num = c(508192:508495) #Can add any tag entries, including breaks/gaps in the sequences
Date = "2023-07-03" #"YYYY-MM-DD"
Lat = "44 37 00" #Degree-Min-Sec format from the boat but only the numbers written with spaces (e.g. "44 16 23")
Lon = "66 34 00"
