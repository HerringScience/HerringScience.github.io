...
```{r}
colors <- c("Total Biomass" = "black", "LRP" = "red", "3yr Moving Average" = "grey")
ggplot(data=LRP2, aes(x=Year, y=Biomass)) +
  geom_point(aes(color = "Total Biomass")) +
  geom_point(data=LRP2, x=LRP2$Year, y=LRP2$'3yr Avg', aes(color = "3yr Moving Average")) +
  geom_hline(yintercept = 317846, linetype = "longdash", size =1, aes(color = "LRP")) +
  scale_y_continuous(labels=scales::comma) +
  theme(axis.text.x = element_text(angle = 55)) +
  labs(x="Year", y = "Biomass (mt)", color = "Legend") +
