...
ggplot(data=FatData2, aes(x=Year, y=Fat)) +
  geom_boxplot() +
  labs(y="Fat Percent (%)")
```
...
```{r}
ggplot(data=subset(FatData2, !is.na(Month)), aes(x=Month, y=Fat)) +
  geom_boxplot() + 
  labs(y="Fat Perecent (%)")
```

### By Supplier {.tabset .tabset-pills}

#### Connors

```{r}
ggplot(data=subset(FatData2, Supplier == "Connors"), aes(x=Year, y=Fat)) +
  geom_boxplot() +
  labs(y="Fat Percent (%)")

ggplot(data=subset(FatData2, Supplier == "Connors" & !is.na(Month)), aes(x=Month, y=Fat, group=Month)) +
  geom_boxplot() +
  labs(y="Fat Percent (%)")
```
...
```{r}
ggplot(data=subset(FatData2, Supplier == "Comeaus"), aes(x=Year, y=Fat)) +
  geom_boxplot() +
  labs(y="Fat Percent (%)")

ggplot(data=subset(FatData2, Supplier == "Comeaus" & !is.na(Month)), aes(x=Month, y=Fat, group=Month)) +
  geom_boxplot() +
  labs(y="Fat Percent (%)")
```
...
```{r}
ggplot(data=subset(FatData2, Supplier == "Scotia"), aes(x=Year, y=Fat)) +
  geom_boxplot() +
  labs(y="Fat Percent (%)")

ggplot(data=subset(FatData2, Supplier == "Scotia" & !is.na(Month)), aes(x=Month, y=Fat, group=Month)) +
  geom_boxplot() +
  labs(y="Fat Percent (%)")
```
...
```{r}
ggplot(data=subset(FatData2, Supplier == "Unknown"), aes(x=Year, y=Fat)) +
  geom_boxplot() +
  labs(y="Fat Percent (%)")

ggplot(data=subset(FatData2, Supplier == "Unknown" & !is.na(Month)), aes(x=Month, y=Fat, group=Month)) +
  geom_boxplot() +
  labs(y="Fat Percent (%)")
```
